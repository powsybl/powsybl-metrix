...
| PERTURBCOST  | R    | 1      | Perturbation déterministe et relative des coûts des variables de groupes et de consommations, pour rendre la trajectoire du solveur reproductible et indépendante du solveur sur instances dégénérées ; 0 = désactivé.<br>= perturbationCout (0.0) |
