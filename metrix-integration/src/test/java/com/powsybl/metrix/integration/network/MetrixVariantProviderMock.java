 ...
 */
public class MetrixVariantProviderMock implements MetrixVariantProvider {

    private final MetrixNetwork network;
    private final TimeSeriesIndex index;

    MetrixVariantProviderMock(MetrixNetwork network, TimeSeriesIndex index) {
    ...
    private Load createLoad(String id, double p0, String busId, LoadDetail detail) {
        ...
        MetrixVariantsWriterTest.AbstractNetworkImplTest underlyingNetwork = mock(MetrixVariantsWriterTest.AbstractNetworkImplTest.class);
