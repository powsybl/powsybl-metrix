...
/* Tableau de travail */
char * T; /* dimensionne au nombre de variables (i.e. toujours > au nombre de contraintes, toujours 0 quand on en a besoin */
...
double * BorneInfInfaisabilitePrimale;     /* Dimensionne au nombre de contraintes */
double * BorneSupInfaisabilitePrimale;     /* Dimensionne au nombre de contraintes */
...
/*------------------------------------------*/
/* Pour la relaxation de contraintes        */
# if RELAXATION_CONTRAINTES == OUI_SPX
  char  FaireDeLaRelaxationDeContrainte; /* OUI_SPX ou NON_SPX */
  char  ContraintesRelaxeesOuReactivees; /* OUI_SPX ou NON_SPX */
  int   NombreDeContraintesRelaxeesAllouees;
  int   NombreDeContraintesRelaxees;
  int * NumerosDesContraintesRelaxees;
  int * MdebContraintesRelaxees;
  int * NbTermContraintesRelaxees;
  double * BContraintesRelaxees;
	int * NombreDeRelaxationsDeLaContrainte;
# endif
