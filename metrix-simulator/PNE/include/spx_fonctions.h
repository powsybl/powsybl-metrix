...
void SPX_MajDesVariablesEnBaseAControler( PROBLEME_SPX * , int , int * , char * );
...
void SPX_CalculerBsHyperCreux( PROBLEME_SPX * , char * , char * , int * , int * );
void SPX_CalculerBsStandard( PROBLEME_SPX * , char * );
...
# if RELAXATION_CONTRAINTES == OUI_SPX 
  void SPX_RelaxerDesContraintes( PROBLEME_SPX * );
  void SPX_ControlerLesContraintesRelaxees( PROBLEME_SPX * , char );
	void SPX_ReinitialisationsRelaxationReactivation( PROBLEME_SPX * );
# endif
