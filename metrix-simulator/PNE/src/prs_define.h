...
# define SEUIL_INF_POUR_FIXATION_BINAIRE  MARGE_INITIALE_VARIABLES_ENTIERES   /*0.0001*/ 
# define SEUIL_SUP_POUR_FIXATION_BINAIRE  (1.0-MARGE_INITIALE_VARIABLES_ENTIERES) /*0.9999*/
...
# define VARIABLE_PROBING_SUR_VARIABLES_BORNEES_DES_2_COTES NON_PNE
...
char PremierPassageDansLePresolve;
...
int * VariableEquivalente; /* Une variable est equivalente si elle en remplace 2 autres
...
int    * NombreDeVariablesQueLaVariableSubstitue;
