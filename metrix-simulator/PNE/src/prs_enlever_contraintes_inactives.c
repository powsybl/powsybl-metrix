...
{
int Cnt0; int Cnt0Max; int il; int * Mdeb0; int * NbTerm0;
double * B0; char * SensContrainte0; int * Nuvar0; double * A0; int il0; int il0Max;
int NombreDeTermesNonNuls; PROBLEME_PNE * Pne; int Var; int NombreDeVariables;
