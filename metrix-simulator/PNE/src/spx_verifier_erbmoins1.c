...
int NbTermesNonNulsDeErBMoinsUn; int * IndexTermesNonNulsDeErBMoinsUn; int j;
char * T; double * Bs; char * PositionDeLaVariable;
...
/*for ( j = 0 ; j < NombreDeValeursNonNulles ; j++ ) T[NumCntNonNul[j]] = 0;*/
