...
#define NOMBRE_MAX_DE_COUPES_HORS_BRANCHE   100000 /* Pas de limite */ 

#define NOMBRE_MAX_DE_COUPES_VIOLEES_AJOUTEES 100000 /* Pas de limite */ 

#define NOMBRE_MAX_DE_TERMES_DES_COUPES_INSEREES 500000

#define NOMBRE_MAX_DE_COUPES_DE_CODE_MOINS_1  100000 /* Pas de limite */ 
