...
while ( 1 ) {
  ...
  for ( i = 0 ; i < NombreDeNoeudsAExplorer ; i++ ) {
    ...
    /*Bb->CalculerDesCoupes = NON_PNE;*/
		/* 10/3/2016 changement de strategie, on calcule des coupes */
    Bb->CalculerDesCoupes         = OUI_PNE;  
    Bb->CalculerDesCoupesDeGomory = OUI_PNE; /* Pour ne pas perdre trop de temps */
