...
/*------------------------------------------------------------------------*/
Spx->T = (char *) malloc( NbVarMx * sizeof( char ) );
/*------------------------------------------------------------------------*/
...
/*------------------------------------------------------------------------*/
Spx->BorneInfInfaisabilitePrimale = (double  *) malloc( NbContr_E * sizeof( double ) );
Spx->BorneSupInfaisabilitePrimale = (double  *) malloc( NbContr_E * sizeof( double ) );
/*------------------------------------------------------------------------*/
...
/*------------------------------------------------------------------------*/     
  Spx->BorneInfInfaisabilitePrimale == NULL ||
  Spx->BorneSupInfaisabilitePrimale == NULL ||	
/*------------------------------------------------------------------------*/     
...
memset( (char *) Spx->T, 0, NbVarMx * sizeof( char ) );

# if RELAXATION_CONTRAINTES == OUI_SPX
  Spx->NombreDeContraintesRelaxeesAllouees = 0;
  Spx->NombreDeContraintesRelaxees = 0;
  Spx->NumerosDesContraintesRelaxees = NULL;
  Spx->MdebContraintesRelaxees = NULL;
  Spx->NbTermContraintesRelaxees = NULL;
  Spx->BContraintesRelaxees = NULL;
...
/*------------------------------------------------------------------------*/
Spx->T = (char *) realloc( Spx->T, NbVarMx * sizeof( char ) );
/*------------------------------------------------------------------------*/
...
/*------------------------------------------------------------------------*/
Spx->BorneInfInfaisabilitePrimale = (double  *) realloc( Spx->BorneInfInfaisabilitePrimale, NbContr_E * sizeof( double ) );  
Spx->BorneSupInfaisabilitePrimale = (double  *) realloc( Spx->BorneSupInfaisabilitePrimale, NbContr_E * sizeof( double ) );  
/*------------------------------------------------------------------------*/
...
free( Spx->BorneInfInfaisabilitePrimale );
free( Spx->BorneSupInfaisabilitePrimale );
...
# if RELAXATION_CONTRAINTES == OUI_SPX
	free( Spx->NumerosDesContraintesRelaxees );
	free( Spx->MdebContraintesRelaxees );
	free( Spx->NbTermContraintesRelaxees );
	free( Spx->BContraintesRelaxees );
