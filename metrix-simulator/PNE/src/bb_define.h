...
# define NOMBRE_MAX_DE_CRITERES_SUCCESSIFS_EGAUX_DANS_UNE_RECHERCHE_EN_PROFONDEUR 20
# define INCREMENT_NOMBRE_MAX_DE_CRITERES_SUCCESSIFS_EGAUX_DANS_UNE_RECHERCHE_EN_PROFONDEUR 2
# define SEUIL_EN_VALEUR_ABSOLUE 1.e-2
# define SEUIL_EN_VALEUR_RELATIVE 1.e-6
...
char PresenceDeVariableEntiereDansLaCoupe; /* OUI_PNE ou NON_PNE car utilisation dans pne */ 
} COUPE;
...
int NombreMaxDeCriteresSuccessifsEgauxDansUneRechercheEnProfondeur;
...
char    CalculerDesCoupesDIntersection;
