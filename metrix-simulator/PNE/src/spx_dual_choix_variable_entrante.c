...
{
int CntBase                      ; int DerniereVariableEntrante; double BBarreDeCntBase; 
int NbTermesBoundFlip            ; double SeuilBound            ; 
double DeltaXSurLaVariableHorsBase; int i0Harris                ; double * Xmax         ;
double * NBarreR                  ; char * PositionDeLaVariable  ; char * TypeDeVariable ;
double * Xmin; int * CNbTerm; 
char * StatutBorneSupCourante; double XsVariableSortante; double XiVariableSortante;
...
BBarreDeCntBase = Spx->BBarre[CntBase];
