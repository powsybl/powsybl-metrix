 ...
 */
package com.powsybl.metrix.mapping.utils;
...
public final class TimeSeriesUtils {
    ...
    public static Map<String, String> getMetadataTags(NodeCalc nodeCalc, ReadOnlyTimeSeriesStore store) {
    ...
    public static Map<String, String> getMetadataTags(String tsName, Map<String, Map<String, String>> tags) {
