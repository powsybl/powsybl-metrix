...
public enum JsonFieldName {
    ...
    TS_TO_BATTERIES("timeSeriesToBatteriesMapping"),
    TS_TO_LOADS("timeSeriesToLoadsMapping"),
    TS_TO_BOUNDARY_LINES("timeSeriesToBoundaryLinesMapping"),
    ...
    BATTERY_TO_TS("batteryToTimeSeriesMapping"),
    LOAD_TO_TS("loadToTimeSeriesMapping"),
    BOUNDARY_LINE_TO_TS("boundaryLineToTimeSeriesMapping"),
    ...
    BATTERY_TS("batteryTimeSeries"),
    LOAD_TS("loadTimeSeries"),
    BOUNDARY_LINE_TS("boundaryLineTimeSeries"),
    ...
    UNMAPPED_BATTERIES("unmappedBatteries"),
    ...
    UNMAPPED_BOUNDARY_LINES("unmappedBoundaryLines"),
    ...
    UNMAPPED_MIN_P_BATTERIES("unmappedMinPBatteries"),
    UNMAPPED_MAX_P_BATTERIES("unmappedMaxPBatteries"),
    ...
    IGNORED_UNMAPPED_BATTERIES("ignoredUnmappedBatteries"),
    IGNORED_UNMAPPED_LOADS("ignoredUnmappedLoads"),
    IGNORED_UNMAPPED_BOUNDARY_LINES("ignoredUnmappedBoundaryLines"),
    ...
    DISCONNECTED_BATTERIES("disconnectedBatteries"),
    DISCONNECTED_LOADS("disconnectedLoads"),
    DISCONNECTED_BOUNDARY_LINES("disconnectedBoundaryLines"),
    OUT_OF_MAIN_CC_GENERATORS("outOfMainCcGenerators"),
    OUT_OF_MAIN_CC_BATTERIES("outOfMainCcBatteries"),
    OUT_OF_MAIN_CC_LOADS("outOfMainCcLoads"),
    OUT_OF_MAIN_CC_BOUNDARY_LINES("outOfMainCcBoundaryLines"),
